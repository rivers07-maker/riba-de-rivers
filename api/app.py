...
from .availability import blueprint as availability_blueprint
...
# Register the availability blueprint
app.register_blueprint(blueprint=availability_blueprint, url_prefix="/")
